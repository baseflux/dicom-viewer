...
<body>
  ...
  <div class="group-filters">
    ...
    <button class="group-filter" data-group="surgery02">Surgery 02 & Limbs</button>
    ...
    <button class="group-filter" data-group="testis">Testis</button>
  </div>
  ...
  <script>
    ...
    function matchesGroup(card, group) {
      ...
      switch (group) {
        ...
        case "surgery02":
          return (
            surgery.startsWith("02")
            || surgery.includes("surg_ankle")
            || surgery.includes("lowerlimb")
            || seriesName.includes("leg")
            || seriesName.includes("hip")
          );
        case "xray":
        ...
        case "testis":
          return seriesName.includes("testis") || surgery.includes("testis") || surgery.includes("scrotum");
        default:
          return true;
      }
    }
